...
public class PlanMapActivity extends FragmentActivity implements OnMapReadyCallback,
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        double p1lat = b.getDouble("p1lat");
        double p1Long = b.getDouble("p1Long");
        String p1Name = b.getString("p1Name");
        LatLng place1 = new LatLng(p1lat, p1Long);
        mMap.addMarker(new MarkerOptions().position(place1).title(p1Name));
        markerPoints.add(place1);


        double p2lat = b.getDouble("p2lat");
        double p2Long = b.getDouble("p2Long");
        String p2Name = b.getString("p2Name");
        LatLng place2 = new LatLng(p2lat, p2Long);
        mMap.addMarker(new MarkerOptions().position(place2).title(p2Name));
        markerPoints.add(place2);

        double p3lat = b.getDouble("p3lat");
        double p3Long = b.getDouble("p3Long");
        String p3Name = b.getString("p3Name");
        LatLng place3 = new LatLng(p3lat, p3Long);
        mMap.addMarker(new MarkerOptions().position(place3).title(p3Name));
