...
public class Map1PlaceActivity extends FragmentActivity implements OnMapReadyCallback,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_map1_place);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        String desc = b.getString("p1Desc");

        final LatLng latLng = new LatLng(p1lat, p1Long);
