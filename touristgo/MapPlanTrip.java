...
/**
 * Created by sirinebaba on 4/3/17.
 */
...
public class MapPlanTrip extends FragmentActivity implements OnMapReadyCallback,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mapplantrip);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap.addMarker(new MarkerOptions().position(place2).title("Marker in Sydney"));

        double p3lat = b.getDouble("p3lat");
        double p3Long = b.getDouble("p3Long");
        LatLng place3 = new LatLng(p3lat, p3Long);
        mMap.addMarker(new MarkerOptions().position(place3).title("Marker in Sydney"));
